...
<div class="flex items-center gap-4 fill-violet-500">
  ...
  <div class="relative">
    ...
    >
      <ul 
        on:mouseleave={()=>setTimeout(()=>isMenuShow=false,1000)}
      ...
      >
        <li>
          <a
            ...
            href="#"
            class="flex items-center px-4 py-1 gap-1 hover:bg-gray-100 fill-violet-500 dark:hover:bg-gray-600 dark:hover:text-white dark:fill-orange-500" 
            >
        ...
        <li>
          <a on:click={()=>{
            ...
            href="#"
            class="flex items-center px-4 py-1 gap-2 dark:fill-orange-500 fill-violet-500 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
            >
        ...
        <li>
          ...
          <a on:click={()=>{
            ...
            class="flex items-center px-4 py-1 gap-1 dark:fill-orange-500 fill-violet-500 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
            >
        ...
        <li>
          <a target="_blank"
            ...
            class="flex items-center px-4 py-1 gap-1 hover:bg-gray-100 fill-violet-500 dark:fill-orange-500 dark:hover:bg-gray-600 dark:hover:text-white"
            >
      ...
      <div class="py-1 flex items-center">
        <a on:click={()=>{
          ...
          href="#"
          class="flex justify-between items-center dark:fill-orange-500 gap-1 px-4 fill-violet-500 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
          >
        ...
        <div class="flex items-center text-xs">ctrl + c</div>
